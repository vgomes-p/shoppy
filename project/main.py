...
while True:
    ...
    if client == "comum":
        ...
        print("Categoria não encontrada! Nossas categorias são: Comum, Prata, Ouro e Diamante. Por, favor, responda uma categoria valida!")
        continue
    break
...
while True:
    ...
    if cart.isdigit():
        ...
        print("O valor da compra não pode ser caracteres, apenas digitos! Por favor, informe um valor valido!")
    break
